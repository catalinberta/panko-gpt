...
const LinkModal = (props: ILinkModal) => {
	...
	useEffect(() => {
		if(props.show) {
			...
			props.config && apiClient.patch<WhatsappConfig>(
				`${ApiPaths.WhatsappConfigs}/${props.config._id}`,
				{
					...props.config,
					enabled: true,
					linked: false,
						...
						<div className=" px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
							<div className="sm:flex sm:items-start">
								<div className="mt-3 flex flex-1 flex-col text-center sm:ml-4 sm:mt-0 sm:text-left h-fit overflow-hidden">
									...
									<h3 className="text-base font-semibold leading-6 text-white">After scan, please give it ~10 seconds to authenticate</h3>
									{isLoading && (
										<div
