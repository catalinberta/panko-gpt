...
interface ICurrentTimeProps extends UseControllerProps {
	
}

const CurrentTime = (props: ICurrentTimeProps) => {
	...
	return (
		<div className="relative flex flex-col bg-clip-border rounded-xl bg-gray-700 text-gray-700 shadow-md">
			...
			<div className="p-4">
				<p className="block antialiased font-sans text-md font-bold leading-normal text-white">Know current time</p>
				<h4 className="block antialiased mt-2 tracking-normal font-sans text-sm font-semibold leading-snug text-white">Allow the bot to know the current time to give time-sensitive answers.</h4>
			</div>
				...
				<div className="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600 text-right">
					<label className="inline-flex items-center mt-6 cursor-pointer flex-row-reverse">
						<input
							...
							{...props.control?.register('functionTime')}
						/>
						<div
